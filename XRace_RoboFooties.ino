...
std::vector<MOTOR_PINS> motorPins = 
{
  ...
  {13, 5, 4},  //LEFT_MOTOR  Pins (EnB, IN3, IN4)
};
...
<html>
  ...
  <body class="noselect" align="center" style="background-color:white">
    ...
    <h1 style="color: teal;text-align:center;">Robofooties</h1>
    <h2 style="color: teal;text-align:center;">Mes Que Un Bot</h2>
...
void elevateCar(int leftBackServoValue)
{
